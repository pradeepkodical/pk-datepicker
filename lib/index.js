...
function CanvasContainer(props) {
    ...
    const height = react.useMemo(() => Math.min(20000, drawItems.reduce((p, c) => p + c.getHeight(), 50)), [drawItems]);
    ...
    return (jsxRuntime.jsx("div", Object.assign({ style: {
            ...
            width: '100%',
            minHeight,
        } }, { children: jsxRuntime.jsx("canvas", { width: width + 50, height: height, ref: canvasRef }, void 0) }), void 0));
}
...
function StackedBarChart(props) {
    ...
    const [selected, setSelected] = react.useState(null);
    const theConfig = react.useMemo(() => (Object.assign(Object.assign({}, defaultConfig$2), config)), [config]);
    const drawItems = react.useMemo(() => {
        const dItems = [];
...
function AchievementsChart(props) {
    const { items, config, tooltip, onClick } = props;
    const [selected, setSelected] = react.useState(null);
    const theConfig = react.useMemo(() => (Object.assign(Object.assign({}, defaultConfig$1), config)), [config]);
    const drawItems = react.useMemo(() => {
        const dItems = [];
...
function AttendeesChart(props) {
    ...
    const theConfig = react.useMemo(() => (Object.assign(Object.assign({}, defaultConfig), config)), [config]);
    const [selected, setSelected] = react.useState(null);
    const drawItems = react.useMemo(() => createDrawItems(attendees, events, theConfig), [attendees, events, theConfig]);
    const handleOnHover = react.useCallback((item) => {
        setSelected(item);
    }, [setSelected]);
    return (jsxRuntime.jsxs("div", Object.assign({ style: {
