...
function CanvasChart(props) {
    ...
    const drawItems = react.useMemo(() => (width > 0 ? getDrawItems(width - 40) : []), [
        getDrawItems,
        width,
    ]);
    return (jsxRuntime.jsxs("div", Object.assign({ ref: ref, style: {
            display: 'flex',
            padding: '10px',
...
function StackedBarChart(props) {
    ...
    const getDrawItems = react.useCallback((width) => createDrawItems$3(items, theConfig), [items, theConfig]);
    return (jsxRuntime.jsx(CanvasChart, { getDrawItems: getDrawItems, onClick: onClick, theConfig: theConfig, tooltip: tooltip }, void 0));
}
...
function AchievementsChart(props) {
    ...
    const getDrawItems = react.useCallback((width) => createDrawItems$2(items, theConfig), [items, theConfig]);
    return (jsxRuntime.jsx(CanvasChart, { getDrawItems: getDrawItems, onClick: onClick, theConfig: theConfig, tooltip: tooltip }, void 0));
}
...
function AttendeesChart(props) {
    ...
    const getDrawItems = react.useCallback((width) => createDrawItems$1(attendees, events, theConfig), [attendees, events, theConfig]);
    return (jsxRuntime.jsx(CanvasChart, { getDrawItems: getDrawItems, onClick: onClick, theConfig: theConfig, tooltip: tooltip }, void 0));
}
...
function BasicGantChart(props) {
    ...
    const getDrawItems = react.useCallback((width) => createDrawItems(items, theConfig, width), [items, theConfig]);
    return (jsxRuntime.jsx(CanvasChart, { getDrawItems: getDrawItems, onClick: onClick, theConfig: theConfig, tooltip: tooltip }, void 0));
}
