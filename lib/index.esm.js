...
function CanvasContainer(props) {
    ...
    return (jsxs("div", Object.assign({ style: {
            ...
            overflow: 'auto',
            minHeight,
        } }, { children: [jsx("canvas", { width: width, height: height, ref: canvasRef }, void 0), children] }), void 0));
}
...
function YearBox(props) {
    ...
    return (jsxs("div", Object.assign({ style: {
            ...
            color: config.textColor,
                    ...
                    } }, { children: year }), void 0) }, void 0), jsx(CanvasContainer, { drawItems: drawItems, onClick: onClick, onHover: (item, x, y) => {
                    if (item) {
                        if (onHover)
                            onHover(item, x, y);
                    }
...
function YearsCalendar(props) {
    ...
    return (jsx("div", { children: Object.keys(groupedItems).map((key, i) => (jsx("div", { children: jsx(YearBox, { year: key, items: groupedItems[key], config: theConfig, onClick: onClick, onHover: onHover }, void 0) }, i))) }, void 0));
}

export { YearsCalendar };
