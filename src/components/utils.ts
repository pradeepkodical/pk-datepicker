...
import { PickerDateRange } from "./types";
...
export const isStartOfRange = ({ startDate }: PickerDateRange, day: Date) =>
	(startDate && isSameDay(day, startDate)) as boolean;

export const isEndOfRange = ({ endDate }: PickerDateRange, day: Date) =>
	(endDate && isSameDay(day, endDate)) as boolean;

export const inDateRange = ({ startDate, endDate }: PickerDateRange, day: Date) =>
	(startDate &&
		endDate &&
...
export const isRangeSameDay = ({ startDate, endDate }: PickerDateRange) => {
